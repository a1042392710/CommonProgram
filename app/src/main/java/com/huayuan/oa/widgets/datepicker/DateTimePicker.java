...
public class DateTimePicker {
    ...
    public DateTimePicker(WeakReference<Context> context, ResultHandler resultHandler) {
    ...
    public DateTimePicker(WeakReference<Context> context, ResultHandler resultHandler, Date startDate, Date endDate) {
        this(context, resultHandler, startDate, endDate, null);
    }

    public DateTimePicker(WeakReference<Context> context, ResultHandler resultHandler, Date startDate, Date endDate, Builder builder) {
        this.context = context;
        this.handler = resultHandler;
        selectedCalender = Calendar.getInstance();
        startCalendar = Calendar.getInstance();
    ...
    private void initDialog() {
        if (datePickerDialog == null) {
            datePickerDialog = new Dialog(context.get(), R.style.DateTimePickerDialog);
            ...
            lp.width = context.get().getResources().getDisplayMetrics().widthPixels;
    ...
    public static class Builder {
        ...
        public Builder(WeakReference<Context>contextWeakReference) {
            ...
            title = contextWeakReference.get().getString(R.string.title);
            cancel = contextWeakReference.get().getString(android.R.string.cancel);
            ok = contextWeakReference.get().getString(android.R.string.ok);
            year = contextWeakReference.get().getString(R.string.year);
            month = contextWeakReference.get().getString(R.string.month);
            day = contextWeakReference.get().getString(R.string.day);
            hour = contextWeakReference.get().getString(R.string.hour);
            minute = contextWeakReference.get().getString(R.string.minute);
            titleTextColor = 0xFF999999;
            cancelTextColor = 0xFF999999;
            okTextColor = 0xFF59B29C;
